        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm font-medium text-blue-600">{{ number_format($trip->price_per_seat, 2) }} €</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                ...
                @empty
                <tr>
                    <td colspan="7" class="px-6 py-4 text-center text-gray-500">Aucun trajet</td>
                </tr>
                @endforelse
            </tbody>
        </table>
